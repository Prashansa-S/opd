#!/bin/bash
{
  ...
  "resourceDetails": [
    {
      "description": "https://github.com/czbiohub/tabula-muris-senis",
      "arn": "arn:aws:s3:::czb-tabula-muris-senis",
      "region": "us-west-2",
      "type": "s3"
    }
  ],
  "moreInformation": "https://github.com/czbiohub/tabula-muris-senis/blob/master/LICENSE",
  "__v": 0,
  "isDeleted": false,
